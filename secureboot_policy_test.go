	...
	for _, data := range []struct {
							...
							&OSComponent{
								...
								Next: []*OSComponent{
									&OSComponent{
										...
										Image:    FileOSComponent("testdata/mock.efi.signed.2")}}}}}}},
			digests: tpm2.DigestList{
				tpm2.Digest{0x4a, 0x4f, 0xd9, 0x0c, 0x84, 0x18, 0xbc, 0x4e, 0x6c, 0x76, 0x3a, 0xcc, 0x6d, 0x88, 0x49, 0xfd, 0xd9, 0x97, 0xce,
					0xaf, 0xba, 0xfe, 0x83, 0x53, 0x8c, 0x50, 0x7d, 0xaf, 0x16, 0x5a, 0xe8, 0xe6}},
		},
		{
				...
				LoadPaths: []*OSComponent{
					&OSComponent{
						...
						Next: []*OSComponent{
							&OSComponent{
								LoadType: DirectLoadWithShimVerify,
								Image:    FileOSComponent("testdata/mock.efi.signed.ca2"),
								Next: []*OSComponent{
									&OSComponent{
										LoadType: DirectLoadWithShimVerify,
										Image:    FileOSComponent("testdata/mock.efi.signed.2")}}}}}}},
		...
		},
		{
			...
			err: "cannot process events from event log: cannot process KEK measurement event: cannot process KEK measurement event 0: " +
				...
				"index 0 (testdata/mockshim2.efi.signed.1): cannot process Shim executable: cannot compute events for subsequent components: " +
				"cannot compute events for component at index 0 (testdata/mock.efi.signed.2): cannot process executable: cannot compute events " +
									...
									&OSComponent{
										...
										Next: []*OSComponent{
											&OSComponent{
												...
												Image:    FileOSComponent("testdata/mock.efi.signed.1")}}}}}}}}},
			digests: tpm2.DigestList{
				tpm2.Digest{0xf7, 0x3b, 0xb2, 0x4f, 0x88, 0xba, 0x33, 0xe9, 0xa9, 0x96, 0x88, 0xbb, 0x47, 0xe7, 0x2e, 0xdd, 0x79, 0x8f, 0x24,
					0x42, 0xc8, 0xe0, 0x72, 0xe0, 0xde, 0x03, 0xcd, 0xe9, 0xed, 0xbb, 0xf3, 0x94}},
		},
		{
		...
		},
		{
			...
			digests: tpm2.DigestList{
				tpm2.Digest{0xe8, 0x01, 0x30, 0xf2, 0xd8, 0x21, 0x2d, 0x69, 0x69, 0xf0, 0xcd, 0x20, 0xef, 0xfc, 0x3b, 0xbd, 0xed, 0x14, 0x58,
					0x48, 0x61, 0xf8, 0xf5, 0x60, 0xfb, 0xc5, 0x20, 0x8a, 0x8b, 0xfc, 0x06, 0x81},
				tpm2.Digest{0xa6, 0x40, 0x25, 0x48, 0x44, 0x24, 0xba, 0x7a, 0x64, 0xdc, 0x11, 0x54, 0x88, 0x9e, 0xb8, 0xfe, 0x78, 0xd7, 0xb2,
					0x04, 0xfa, 0x58, 0x1a, 0xce, 0x55, 0x52, 0x2c, 0x07, 0x40, 0x50, 0xe4, 0x28}},
		},
		{
			...
			digests: tpm2.DigestList{
				tpm2.Digest{0xe8, 0x01, 0x30, 0xf2, 0xd8, 0x21, 0x2d, 0x69, 0x69, 0xf0, 0xcd, 0x20, 0xef, 0xfc, 0x3b, 0xbd, 0xed, 0x14, 0x58,
					0x48, 0x61, 0xf8, 0xf5, 0x60, 0xfb, 0xc5, 0x20, 0x8a, 0x8b, 0xfc, 0x06, 0x81},
				tpm2.Digest{0x38, 0xae, 0x1e, 0x75, 0xea, 0x72, 0x37, 0x98, 0x3f, 0x4d, 0x44, 0xc3, 0x69, 0x5e, 0x08, 0xa1, 0xd7, 0xb6, 0x0d,

...
var (
	shimGuid = tcglog.EFIGUID{0x605dab50, 0xe046, 0x4300, 0xabb6,
		[...]uint8{0x3d, 0xd8, 0x10, 0xdd, 0x8b, 0x23}}
	efiGlobalVariableGuid = tcglog.EFIGUID{0x8be4df61, 0x93ca, 0x11d2, 0xaa0d,
		[...]uint8{0x00, 0xe0, 0x98, 0x03, 0x2b, 0x8c}}
	efiImageSecurityDatabaseGuid = tcglog.EFIGUID{0xd719b2cb, 0x3d3a, 0x4596, 0xa3bc,
		[...]uint8{0xda, 0xd0, 0x0e, 0x67, 0x65, 0x6f}}

	efiCertX509Guid = tcglog.EFIGUID{0xa5c059a1, 0x94e4, 0x4aa7, 0x87b5,
		[...]uint8{0xab, 0x15, 0x5c, 0x2b, 0xf0, 0x72}}

	dosImageSignature uint16 = uint16('M') | (uint16('Z') << 8)
)
...
func tryHarderToGetOptionalPeHeader(pefile *pe.File, r io.ReaderAt) (interface{}, error) {
	// If optional header size is 0, return empty optional header.
	if pefile.FileHeader.SizeOfOptionalHeader == 0 {
		return nil, nil
	}
